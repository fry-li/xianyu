<template>
  <section class="container">
    ...
    <el-row type="flex" class="statement">
      <el-col :span="8">
        <i class="iconfont iconweibiaoti-_huabanfuben" style="color:red;"></i>
          <span>100%航协认证</span>
      </el-col>
      <el-col :span="8">
        <i class="iconfont iconbaozheng" style="color:blue;"></i>
          <span>出行保证</span>
      </el-col>
      <el-col :span="8">
        <i class="iconfont icondianhua" style="color:green;"></i>
          <span> 7x24小时服务</span>
      </el-col>
    </el-row>
